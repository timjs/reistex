...
\HL
\NC Spectral range                  \NC 0.1 -- 1.5 \Milli\Meter \NR
\NC Micro-pulse frequency           \NC 3 \Giga\Hertz           \NR
\NC Micro-pulse duration            \NC 10 -- 100 \Pico\Second  \NR
\NC Macro-pulse duration            \NC 10 -- 15 \Micro\Second  \NR
\NC Repetition rate of macro-pulses \NC 10 \Hertz               \NR
\NC Electron beam energy            \NC 10 -- 15 \Mega\EVolt    \NR
\NC Undulator period                \NC 110 \Milli\Meter        \NR
\NC Number of undulator periods     \NC 40                      \NR
\NC Undulator parameter Krms        \NC 0.7 -- 3.4              \NR
\NC Optical cavity length           \NC 7.5 \Meter              \NR
\HL
\stoptabulate
\stopbuffer
\typebuffer
...
\section[sec:synoniemen]{Synoniemen}
...
Gelukkig kan \CONTEXT\ goed omgaan met \emph{synoniemen} (\emph{\en synonyms})\seedocumentation{24}{9.2}. We hoeven een afkorting maar één keer te definiëren, en daarna kun je hem steeds weer opnieuw gebruiken. We zijn er onderweg al twee tegengekomen. Namelijk \MC\ en \FLARE. Ze zijn gedefinieerd met \tex{abbreviation}.
