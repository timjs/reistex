...
\subsection{@\emph@ en @\start/stopemphasize@}%TODO: add \alert
...
\subsection[sec:report]{@\start/stopchapter@}%TODO: rewrite
...
\definetabulate[personalia]
  [|lw(5em)|p|rw(8em)|]

\startpersonalia
\NC \hbox{\externalfigure[pierrecurie][passphoto]}
\NC Pierre Curie\crlf
    Heyendaalseweg 135\crlf
    6525 AJ Nijmegen
\NC (024) 36 52 079
\NR
\stoppersonalia
...
\NC  4   \NC   tekst    \NC   inhoud, meestal wil je hier @\externalfigure@ gebruiken\footnote{Maar je kunt natuurlijk ook een tabel plaatsen en die samen nummeren met de figuren. Mocht je dat om een of andere onverklaarbare reden willen\dots}  \NR
\stopargumenttable
\stopframedtext
