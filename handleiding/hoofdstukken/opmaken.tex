...
\NC  4   \NC   tekst    \NC   inhoud, meestal wil je hier \tex{externalfigure} gebruiken\footnote{Maar je kunt natuurlijk ook een tabel plaatsen en die samen nummeren met de figuren. Mocht je dat om een of andere onverklaarbare reden willen\periods}  \NR
\stopargumenttable
\stopframedtext
