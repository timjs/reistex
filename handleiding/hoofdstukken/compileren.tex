...
Je kunt vanaf je eigen computer inloggen op de servers van de universiteit. Voor Windows heb je het programma PuTTY of XWin nodig. Op Linux of \MACOSX\ kun je gebruik maken van het standaard commando @ssh@.
...
Ben je misschien @\stopchapter@ vergeten?
\stopitemize

\section{Overbodige bestanden opruimen}

Tijdens het compileren produceert \CONTEXT\ een hele hoop hulpbestanden. Om die in een klap te verwijderen, zonder je bronbestand en je \PDF'je kun je gebruik maken van @tex-purge@.
