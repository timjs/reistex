...
\startchapter[title=Russia versus Europe]
...
Through great territorial expansion, Russia became a nation with a lot of different peoples. There was not really a common identity. Of course in different parts of Russia, groups would identify themselves as one people. For example in the European part of Russia, many people identified themselves as Russians. But there was no \quote{people of Russia} in the whole \unit{17.098.242 km^2} that belongs to the nation Russia.
...
\doifmode{reader}{\page[bigpreference]}% Alleen voor reader --TS
...
\doifmode{reader}{\page[yes]}% Alleen voor reader --TS
