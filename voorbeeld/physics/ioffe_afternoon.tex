...
\report[fys:ioffe_aft]{Ioffe Physical Technical Institute\\ (the afternoon)}
       {\date[d=13,m=10,y=2009]} {Maarten van de Griend \& Martijn Jongen}
...
\placefigure[outer]
  ...
  {\externalfigure[globus_scheme][width=0.7\textwidth]}
