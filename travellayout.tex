...
\defineprefixset[default]%TODO: hier of bij handleiding?
  [chapter,section,subsection]
\defineresetset[default]
  [1,0][1]% reset parts niet, chapters wel, rest niet

\setupheads
  [sectionset=default,% Slaat op prefix
   number=no]

\setuphead[part]
  [number=no,
   %resetnumber=no,% Nu met reresetset...
   placehead=yes,
   page=right,
...
\setupcombinedlist[content]
  [alternative=a,
   list={part,chapter}]
   %interaction=pagenumber]%TODO: werkt niet?
