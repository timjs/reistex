...
\startmode[lucida]
  ...
  \define\word{\lowercase}
  \setupsynonyms[abbreviation]
    [textstyle={\cap\word}]
\stopmode
\doifmode{8} {\setupbodyfont[8pt]}
\doifmode{85}{\setupbodyfont[8.5pt]}
\doifmode{9} {\setupbodyfont[9pt]}
\doifmode{95}{\setupbodyfont[9.5pt]}
\doifmode{10}{\setupbodyfont[10pt]}
...
\startmode[makeup]
  ...
  alphabeth width \the\wd\scratchbox
  \version[temporary]
  \page[right]
\stopmode
...
%D Een hack om de URL's in bibliografieën netjes te houden. \tex{redefine} i.s.m.
%D \tex{gobbleoneargument} werkt niet, dus we moeten wel de argumenten scannen.
%D Lijkt alsof we dit niet nodig hebben, omdat de oude \tex{gotoURL} bij niet
%D interactieve documenten intern netjes gebruik maakt van \tex{hyphenatedurl},
%D maar er gaat toch iets mis als we \tex{url} hierboven herdefiniëren.
%D FIXME: neemt niet de opmaak over van \tex{setupurl}...
